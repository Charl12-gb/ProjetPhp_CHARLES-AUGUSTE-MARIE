...
<?php
            ...
            if(isset($_REQUEST['err'])){
                echo '<div style="text-align: right;"> Nombre de livre invalide.</div>';
            }
    ?>
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Site (Editer)</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/site_modu_ins.php?edit=<?php echo $nomSite ;?>" Method="POST">
                                        <div class="form-body">
                                            <div class="row">
                                                    <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="roundText">Nom site : </label>
                                                        <input type="text" name="nomSit" id="nomSit" value="<?php echo $ligne['nomSite'] ;?>" id="roundText" class="form-control round">
                                                    </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="text-id-vertical">Année decouverte : </label>
                                                            <input type="number" name="anne" id="anne" value="<?php echo $ligne['anneedecouv'] ;?>" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
