<?php
    ...
    $sql_afficher_vu = $connexion->prepare(
        "SELECT * FROM `biblio` WHERE numMus = '$numM' AND isbn = '$is'"
    );
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Bibliothèque (Editer)</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/biblio_modu_ins.php?edit=<?php echo $ligne['numMus'] ;?>&isb=<?php echo $ligne['isbn'] ;?>" Method="POST">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="form-group">
                                                                ...
                                                                while($l=$sql_afficher_site->fetch()){
                                                                    ?>
                                                                    <option value="<?php echo $l['numMus'] ;?>"><?php echo $l['numMus'] ;?></option>    
                                                                <?php 
                                                                    }
                                                                ?>
                                                                </select>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="form-group">
                                                                ...
                                                                <?php
                                                                    while($li=$sql_afficher_ouvrage->fetch()){
                                                                    ?>
                                                                        <option value="<?php echo $li['isbn'] ;?>"><?php echo $li['isbn'] ;?></option>    
                                                                    <?php 
                                                                    }
                                                                ?>
                                                                </select>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="dat" id="dat" value="<?php echo $ligne['dateAchat'] ;?>" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
