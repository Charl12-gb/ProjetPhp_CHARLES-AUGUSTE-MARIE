                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Pays</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/pays_modu_ins.php" Method="POST">
                                        <div class="form-body">
                                            <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="roundText">Code Pays : </label>
                                                            <input type="text" name="cd" id="cd" placeholder="Code Pays" id="roundText" class="form-control round" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="roundText">Nombre habitant : </label>
                                                            <input type="number" name="nb" id="nb" placeholder="Nombre habitant" id="roundText" class="form-control round" required>
                                                        </div>
                                                    </div>
