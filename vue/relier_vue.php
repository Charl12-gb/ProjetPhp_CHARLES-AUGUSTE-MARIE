                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Relier</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/relier_modu_ins.php" Method="POST">
                                        <div class="form-body">
                                            <div class="row">
                                            <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <select class="form-select"  name="nomSite1" id="nomSite1" id="roundText" class="form-control round">
                                                                <?php
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="first-name-vertical">Site : </label>
                                                            <fieldset class="form-group">
                                                                <select class="form-select"  name="nomSite2" id="nomSite2" id="roundText" class="form-control round">
                                                                <?php
                                                                    while($lig=$sql_afficher_site2->fetch()){
                                                                        ?>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="dist" id="dist" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
