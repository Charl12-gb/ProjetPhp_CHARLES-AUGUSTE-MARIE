                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Visiter</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/visiter_modu_ins.php" Method="POST">
                                        <div class="form-body">
                                            <div class="row">
                                            <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <select class="form-select"   name="numM" id="numM" id="roundText" class="form-control round">
                                                                <?php
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="nbV" id="nbV" placeholder="Nbre visiteur" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
