<?php
    ...
    $cdisbn = $_REQUEST['edit'];

    $sql_afficher_vu = $connexion->prepare(
        "SELECT * FROM `ouvrage` WHERE isbn = '$cdisbn'"
    );
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Ouvrage (Editer)</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/ouvrage_modu_ins.php?isb=<?php echo $cdisbn ;?>" Method="POST">
                                        <div class="form-body">
                                            <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="roundText">ISBN : </label>
                                                            <input type="text" name="is" id="is" value="<?php echo $ligne['isbn'] ;?>" placeholder="ISBN" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="roundText">Nombre de page : </label>
                                                            <input type="number" name="nbp" id="nbp" value="<?php echo $ligne['nbpage'] ;?>" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="text-id-vertical">Titre : </label>
                                                            <input type="text" name="titre" id="titre" value="<?php echo $ligne['titre'] ;?>" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <select class="form-select"  name="c" id="c" id="roundText" class="form-control round">
