                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Referencer</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/referencer_modu_ins.php" Method="POST">
                                        <div class="form-body">
                                            <div class="row">
                                            <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <select class="form-select"  name="nomSite" id="nomSite" id="roundText" class="form-control round">
                                                                <?php
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="np" id="np" placeholder="Numero de page"  id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
