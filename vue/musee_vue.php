                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="text-decoration: underline;">Formulaire Musée</h2>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../module/musee_modu_ins.php" Method="POST">
                                        <div class="form-body">
                                            <div class="row">
                                                    <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="roundText">Nom musée : </label>
                                                        <input type="text" name="nom" id="nom" placeholder="Nom du musee" id="roundText" class="form-control round">
                                                    </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="text-id-vertical">Nombre de livre : </label>
                                                            <input type="number" name="nbl" id="nbl" placeholder="Nbre livre" id="roundText" class="form-control round">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
